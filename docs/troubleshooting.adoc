...
= Troubleshooting — tentacles-agentic-syllabus
:revdate: 2026-MM-DD
...
* `https://github.com/hyperpolymath/tentacles-agentic-syllabus/issues?q=is%3Aissue+<your symptom>` — has anyone hit this before?
