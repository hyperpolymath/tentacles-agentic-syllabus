...
= Contributing — tentacles-agentic-syllabus
:revdate: 2026-MM-DD

== Audience

Developers working *on* `tentacles-agentic-syllabus`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/tentacles-agentic-syllabus.git
cd tentacles-agentic-syllabus
...
* Bugs in `tentacles-agentic-syllabus`: file at `hyperpolymath/tentacles-agentic-syllabus/issues`.
